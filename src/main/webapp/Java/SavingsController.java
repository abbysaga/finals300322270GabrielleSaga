...
public class SavingsController {
    ...
    @Autowired
    SavingsCategory service;

    @Autowired
    SavingsConnections connect;
    ...
    public String showCategorypage2(ModelMap model, @RequestParam(defaultValue = "") String id) throws ClassNotFoundException, SQLException {
        service1 = new DatabaseService(connect.connect());
    ...
    // method that will call items jsp
